...
#include "communicationSerialTransfer.h"

CommunicationSerialTransfer::CommunicationSerialTransfer() {
}

int CommunicationSerialTransfer::_process(CommuicationQueueMessageStruct& message, unsigned long timestamp, unsigned long delta) {
  // uint16_t sendSize = 0;
...
bool CommunicationSerialTransfer::_read(CommuicationQueueMessageStruct* communication, unsigned long timestamp, unsigned long delta) {
...
int CommunicationSerialTransfer::_send(CommuicationQueueMessageStruct& message) {
...
bool CommunicationSerialTransfer::_setup(HardwareSerial& serial, bool debug) {
